...
export const obterYTMP4 = async(id_video) =>{
    return new Promise ((resolve, reject)=>{
        try{
            ...
            let videoStream = ytdl(id_video, {quality: "highest", filter:"videoandaudio", requestOptions: {headers: {cookie: COOKIE}}})
